...
class MoviesView2 extends StatefulWidget {
  const MoviesView2({Key? key}) : super(key: key);

  @override
  State<MoviesView2> createState() => _MoviesView2State();
}

class _MoviesView2State extends State<MoviesView2>
