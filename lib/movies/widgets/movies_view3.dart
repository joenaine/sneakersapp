...
class MoviesView3 extends StatefulWidget {
  const MoviesView3({Key? key}) : super(key: key);

  @override
  State<MoviesView3> createState() => _MoviesView3State();
}

class _MoviesView3State extends State<MoviesView3>
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: reebok.length,
                itemBuilder: (_, index) {
                  final movie = reebok[index];
